...
export default function AuthMenu({ authPage, setAuthPage, detailsPage, setDetailsPage }) {
    return (
        <View style={styles.container}>
            ...
            >
                {authPage == 0 ? 
                    <Text>Don't have an accaunt? <Text style={styles.bottomButtonText}>Sign up</Text></Text>
                    :
                    <Text>Already have an accaunt? <Text style={styles.bottomButtonText}>Sign in</Text></Text>
                }
